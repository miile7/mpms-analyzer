...
from matplotlib.backends.qt_editor.formlayout import (FormWidget, FormComboWidget,
                                                      FormTabWidget, FontLayout,
                                                      ColorLayout, ColorButton)
...
class ToolPlotPage(QtWidgets.QWizardPage):
    ...
    def initializePage(self):
        ...
        self.setWidgetChangeCallback(self._edit_widget, lambda: apply_callback(self._edit_widget.get()))
    ...
    def setWidgetChangeCallback(self, formwidget, callback):
        ...
        Parameters
        ----------
            formwidget : matplotlib.backends.qt_editor.formlayout.FormWidget,
                         matplotlib.backends.qt_editor.formlayout.FormTabWidget, 
                         matplotlib.backends.qt_editor.formlayout.FormComboWidget
        ...
        elif (isinstance(formwidget, FormWidget) and formwidget.widgets != None and
               isinstance(formwidget.widgets, (list, tuple))):
            # formwidget is a form widget, set the callbacks on each field
            for field in formwidget.widgets:
                self.setWidgetChangeCallback(field, callback)
