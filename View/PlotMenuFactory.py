...
class PlotMenuFactory(NavigationToolbar):
    ...
    def edit_parameters(self):
        ...
        self.figure_edit(axes, self, True)
    ...
    def figure_edit(self, axes, parent = None, show_dialog = False):
...
#            if isinstance(datalist[0][0], (list, tuple)):
            formwidget = FormTabWidget(datalist, parent=parent)
#            elif len(datalist[0]) == 3:
#                formwidget = FormComboWidget(datalist, parent=parent)
#            else:
#                formwidget = FormWidget(datalist, parent=parent)
            
            # replace the line edit for the title with a textfield
#            if isinstance(formwidget, (FormTabWidget, FormComboWidget)):
#                layout = formwidget.widgetlist[0].formlayout
#                item = layout.itemAt(0, QtWidgets.QFormLayout.FieldRole)
#                
...
#                                QtWidgets.QTextEdit())
            ...
            return formwidget, apply_callback
